...
<div class="form-control-container"><label><span class="form-control__label" data-stable-name="SsnLabel">Please enter the last 4 digits of your Social Security Number</span><span class=".k-widget.k-formatter"><input type="tel" class="form-control k-textbox" aria-label="Please enter the last 4 digits of your Social Security Number"><input aria-label="Please enter the last 4 digits of your Social Security Number" autocomplete="new-value" class="form-control k-textbox" data-cfw-field="data-cfw-field" data-field-id="Ssn" data-field-type="System.String" data-mask="***-**-****" data-pattern="000-00-0000" data-pattern-msg="Please enter the last 4 digits of your Social Security Number." data-persistent="True" data-placeholder="" data-required-msg="This field is required." data-role="formatter" data-stable-name="SsnInput" data-unmask="True" data-val-length="The field must be a 4 digits number." id="Ssn" maxlength="4" name="1" pattern="^\d{4}$" required="required" type="tel" value="" style="display: none;"></span>
